    ...
    return (
        <div className="">
            <div className="overflow-hidden ">
                <div
                    id="offcanvas"
                    className="absolute left-[-500px] bg-black h-[500px] w-[300px] overflow-hidden transition-all fade-in-out z-[10000000000000]"
                >
                    ...
                    <h1 className="text-center text-white font-bold mx-10  text-3xl my-10">
                        P;Club - IITI
                    </h1>
                    <ul className=" w-fit mx-auto ">
                        ...
                        <Link className="" href="/EventsPage">
                        ...
                        <Link className="" href="/ProjectPage">
                            <li className="my-2 mx-auto border-2 hover:invert transition-all fade-in-out focus:invert p-2 rounded-md text-center w-[200px] bg-black text-white">
                                Projects
                            </li>
                        </Link>
                        <Link className="" href="/TeamPage">
                            <li className="my-2 mx-auto border-2 hover:invert transition-all fade-in-out focus:invert p-2 rounded-md text-center w-[200px] bg-black text-white">
                                Our Team
                            </li>
                        </Link>
