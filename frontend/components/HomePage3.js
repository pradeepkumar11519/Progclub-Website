...
export default function HomePage3() {
    useEffect(() => {
        ...
        for (let x = 0; x < xRows; x++) {
            ...
            for (let z = 0; z < zRows; z++) {
                ...
                let colours = [0x4444ff, 0x4477ff, 0x7744ff, 0xff8080];
        ...
        function checkRow() {
            ...
            for (let x = 0; x < xRows; x++) {
                for (let z = 0; z < zRows; z++) {
                    ...
                    let scale =
                        (cubes[x][z].position.z + group.position.z) / 1500;
                    if (scale < 1) scale = 1;
    ...
    return (
        <div
            id="container"
            className="bg-no-repeat   overflow-x-hidden relative !w-full "
        >
