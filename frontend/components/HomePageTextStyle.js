    ...
    return (
        <div>
            <div className=" text-center absolute w-full h-full">
                <div
                    id="canvas"
                    className="bg-cover bg-center bg-no-repeat text-center my-auto flex justify-center items-center font-bold lg:text-5xl  text-white text-xl sm:text-3xl md:text-4xl  h-screen"
                >
                    <div className="grid grid-rows-3 text-center  my-auto items-center">
                        ...
                        <div className=" pb-5 text-xs flex-wrap md:text-2xl flex justify-center  max-w-full break-all h-full">
                            <div className="grid grid-cols-5 md:flex mx-5 text-center justify-between">
                                <h1
                                    className="md:mb-5 md:mt-10 my-5 mx-2"
                                    id="h1"
                                    data-value="TO"
                                >
                                    TO
                                ...
                                <h1
                                    className="md:mb-5 md:mt-10 mx-2"
                                    id="h6"
                                    data-value="LIKE"
                                >
                                    LIKE
