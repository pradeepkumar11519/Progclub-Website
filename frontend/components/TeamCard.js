...
export default function TeamCard({ team }) {
	...
	return (
		<div className='sm:mx-5 relative my-5 z-[10000] flex justify-center'>

			<div className="card">
				<div className="img">
					<Image width={100} height={100} src={team.image} placeholder="blur" blurDataURL={team.image} />
				</div>
				<span>About Me</span>
				<p className="info">
					<div>My Self {team.name}</div>
					<div>{team.division} Division</div>
					<div>I am a {team.position} For This club</div>
					<div>Email : {team.email}</div>
					
					
				</p>
				
				<div className="share pb-10">
