...
export default function Navbar() {
    ...
    return (
        <div className={`z-[10000000000] fixed w-full top-0`}>
            <div
                id="nav"
                className=" flex lg:grid grid-cols-2 justify-between md:pr-10 pr-3 pl-3 py-3 w-full absolute bg-backdrop shadow-[1px_1px_10px_1px]  text-white "
            >
                ...
                <ul className="lg:grid hidden grid-cols-5">
                    <li className=" py-2 px-0 border-0 text-center my-auto font-bold">
                        <Link href="/">
                            <button className="btn  px-4 py-1 rounded-2xl">
                                Home
                            </button>
                        </Link>
                    </li>
                ...
                <button
                    id="offcanvas-btn"
                    className="offcanvas-btn lg:hidden !ml-auto"
                    data-offcanvas-button
                    onClick={() => {
                        OpenOffCanvas();
                    }}
                >
